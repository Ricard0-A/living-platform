...
import Reasons from "@/components/Features/Reasons";
        ...
        <section className="w-full">
          ...
          <div className="w-full flex justify-center ">
            ...
            bg-[#0B0E52] text-white whitespace-nowrap rounded-xl"
              >
                <p className="hidden md:block text-lg font-medium ps-3">
                  Search
                </p>
          ...
          <div className="flex justify-center w-full md:hidden">
            <div className="flex justify-center w-85 h-10 bg-black ">
              <ul className="flex overflow-hidden items-center text-sm text-white gap-5 h-10 w-[95%] ">
